...
![fig. 1.1: general structure of a open loop control](images/fig01-001.png)
...
![fig. 1.2: general structure of a close loop control](images/fig01-002.png)
...
![fig. 1.3 Heating System](images/fig01-003.png)

![fig. 1.4 representation of a heating System in blocks](images/fig01-004.png)
...
![fig. 1.5 example of the production of a metalic product](images/fig01-005.png){width="60%"}
...
![fig. 1.6 Assembly process](images/fig01-006.png){width="80%"}

Box Stacker:

![fig. 1.7 process of box positioning for further transport.](images/fig01-007.png){width="80%"}

## Resume: Types of processes and types of control

![fig. 1.8 resume of processes and control types](images/fig01-008.png){width="80%"}
